...
export function generateData(x = 3, y = 2, z = 1, gData = []) {
    // x: The total number of nodes at each level. y: There are y nodes and sub-nodes in each level of nodes. z: The number of levels of the tree (0 represents one level)
  ...
  console.log('Total number of nodes (single tree）：', calcTotal());
  // Performance test: When the total number of nodes exceeds 2000 (z needs to be smaller), it obviously feels slow. When z becomes large, there will be too much recursion and it will get stuck.
