...
export default function Header() {
    return (
        <header className="flex justify-between items-center min-h-[88px] px-5 bg-zinc-900 border-b border-neutral-600">
            <button aria-label="Menu">
                <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlnsXlink="http://www.w3.org/2000/svg">
